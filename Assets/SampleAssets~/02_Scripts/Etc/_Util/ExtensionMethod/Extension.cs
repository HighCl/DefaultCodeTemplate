...
namespace DefaultSetting.Utility
{
    public static class Extension
    {
        ...
        #region Vector
        public static Vector2 SetX(this Vector2 vec, float value) => new Vector3(value, vec.y);
        public static Vector2 SetY(this Vector2 vec, float value) => new Vector3(vec.x, value);

        public static Vector3 SetX(this Vector3 vec, float value) => new Vector3(value, vec.y, vec.z);
        public static Vector3 SetY(this Vector3 vec, float value) => new Vector3(vec.x, value, vec.z);
        public static Vector3 SetZ(this Vector3 vec, float value) => new Vector3(vec.x, vec.y, value);
        #endregion
